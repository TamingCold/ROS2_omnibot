...
def generate_launch_description():
    ...
    for i in range(1,N + 1):
        ...
        y_pose = LaunchConfiguration(f'y_pose_{i}', default=str((i - 1) * 5.0))
        ...
        declare_y_position_cmd = DeclareLaunchArgument(
            f'y_pose_{i}', default_value=str((i - 1) * 5.0),
    ...
    omni_drive_cmd_3 = Node(package='omnibot_ignition',
        executable='omni_drive',
        name='omni_drive',
        namespace='robot_3'
    )
    ...
    ld.add_action(omni_drive_cmd_3)
